...
# Extract Covid data
extract.California(tmp_county_path, 'california', 'csv', 'w', utils.california_url)
...
extract.Georgia(tmp_county_path, 'georgia', 'json', 'w', utils.georgia_url)
...
# Clean Covid data
clean.California(f'{tmp_county_path}/california.csv', 'csv', county_path)
